...
2. Enrich a calendar:
   ```bash
   curl "http://localhost:8080/enrich?url=https://scientia-eu-v4-api-d4-02.azurewebsites.net//api/ical/ca05f91a-6c36-45db-9b40-6d011398ed58/017be310-533f-dd3e-b53b-469dd718a317/timetable.ics"
   ```
